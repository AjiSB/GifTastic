$(document).ready(function(){
    ...
    let topics=["lion","tiger","panther","cheetah","elephant","giraffe","monkey","fox","bear","leopard"];
    let loopCounter = sessionStorage.getItem("count");
    console.log(loopCounter)
    // Created to get session storage to loop through the stored animals added by the user 
